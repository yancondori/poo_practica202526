...
**Nivel implementado:** Nivel 2 (hasta 7 puntos)  
...
2. [Nivel 2 — Implementacion (hasta 7 puntos)](#nivel-2)
   ...
   - 2.5 Menu textual
3. [Nivel 3 — Pendiente (hasta 10 puntos)](#nivel-3)
...
## 3. Nivel 3 — Pendiente (hasta 10 puntos)

<!-- TODO Nivel 3: completar esta seccion al implementar cada funcionalidad -->

Las siguientes funcionalidades estan pendientes de implementacion para optar al Nivel 3:

**Planificador — simulaciones avanzadas:**

- [ ] `ejecutarCompleja()`: entran en juego los mecanicos. Al menos 1 de cada perfil (efectivo y estandar) debe reparar al menos 2 problemas en cada cinta.
- [ ] `ejecutarMuyCompleja()`: entran operarios, mecanicos estandar y administrador del sistema. De 2 a 3 problemas por cadena + al menos 1 caida de luz que el AdminSistema debe resolver (2s gestion + 3s cadenas).

**Almacen — gestion completa:**

- [ ] Almacenar informacion relacionada con las cadenas de montaje (historial de produccion por fecha y componente).
- [ ] Diseno desacoplado que permita cambiar la estructura de datos sin modificaciones severas.

**Dashboard — implementacion completa:**
- [ ] Gestion visual de vehiculos, cadenas de montaje y almacen.
- [ ] Diseno que permita reemplazar el subsistema de visualizacion facilmente.

**Listados y estadisticas:**
- [ ] Listado de operarios con filtrado por productividad y ordenacion alfabetica.
- [ ] Listado de vehiculos ensamblados con filtrado por componentes y ordenacion alfabetica.
- [ ] Listado de configuraciones de vehiculos con mayor tasa de ensamblaje.
- [ ] Listado de cadenas de montaje con filtrado por fecha, mostrando vehiculos producidos con sus componentes.

**Interfaz textual:**
- [ ] Implementar las funciones del nivel 2 como opciones completas del menu.

<!-- TODO Nivel 3: al implementar cada punto, documentar aqui la logica, las decisiones de diseno
     y las asunciones adicionales que se hayan tomado. -->
